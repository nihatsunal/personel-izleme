...
3. Copy the all the files of fairness in that directory.
   ...
   If you want to get updated in the future just run 'git fetch https://github.com/leancode/fairness.git'. But do follow the rest of the upgrade instructions below!
