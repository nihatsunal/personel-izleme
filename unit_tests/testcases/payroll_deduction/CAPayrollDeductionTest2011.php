...
class CAPayrollDeductionTest2011 extends PHPUnit_Framework_TestCase {
	...
	function testCA_2011a_EI_LowIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getEmployeeEI() ), '10.46' );
		$this->assertEquals( $this->mf( $pd_obj->getEmployerEI() ), '14.65' );
	}
}
?>