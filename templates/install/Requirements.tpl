...
<div id="rowContentInner">
		...
		<form method="get" action="{$smarty.server.SCRIPT_NAME}">
				...
				<tr>
					...
					<td class="cellRightEditTable">
						...
						{elseif $check_timetrex_version == 2}
							...
							<a href="https://github.com/leancode/fairness">{t escape="no" 1=$install_obj->getLatestTimeTrexVersion()}Download v%1 Now{/t}</a>
						{/if}
						</span>
					</td>
				</tr>
			...
			*}
							...
							<!-- leancode if $install_obj->getTTProductEdition() >= 20 -->
							<tr>
								<td class="cellLeftEditTable">
									{t}MCRYPT Enabled:{/t}
								</td>
