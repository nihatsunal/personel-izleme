		...
		<form method="get" action="{$smarty.server.SCRIPT_NAME}">
				...
				<tr class="tblDataWarning">
					<td colspan="2">
						...
						<br>
						{t escape="no"}The latest version can be downloaded from:{/t} <a href="https://github.com/leancode/fairness" target="_blank"><b>https://github.com/leancode/fairness</b></a>
						<br>
						<br>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cellRightEditTable">
						The source code of Fairness is publicly hosted on <a href="https://github.com/leancode/fairness" target="_blank"><strong>Github</strong></a>.
						<br>
						<br>
					</td>
				</tr>
