...
//				if ( getTTProductEdition() >= PRODUCT_PROFESSIONAL_15 ) {
					...
					$custom_column_labels = $rcclf->getByCompanyIdAndTypeIdAndFormatIdAndScriptArray( $this->getUserObject()->getCompany(), array(10,20), NULL, 'T4SummaryReport', 'custom_column' );
...
//				if ( getTTProductEdition() >= PRODUCT_PROFESSIONAL_15 ) {
					$rcclf = TTnew( 'ReportCustomColumnListFactory' );
					$retval = $rcclf->getByCompanyIdAndTypeIdAndFormatIdAndScriptArray( $this->getUserObject()->getCompany(), array(30,31), NULL, 'T4SummaryReport', 'custom_column' );
//				}
                break;
...
//				if ( getTTProductEdition() >= PRODUCT_PROFESSIONAL_15 ) {
					$rcclf = TTnew( 'ReportCustomColumnListFactory' );
					$report_dynamic_custom_column_labels = $rcclf->getByCompanyIdAndTypeIdAndFormatIdAndScriptArray( $this->getUserObject()->getCompany(), array(10,20), array(10,40,50,90), 'T4SummaryReport', 'custom_column' );
...
//				if ( getTTProductEdition() >= PRODUCT_PROFESSIONAL_15 ) {
					$rcclf = TTnew( 'ReportCustomColumnListFactory' );
					$report_static_custom_column_labels = $rcclf->getByCompanyIdAndTypeIdAndFormatIdAndScriptArray( $this->getUserObject()->getCompany(), array(10,20), array(20,30,60,70,80,100,110), 'T4SummaryReport', 'custom_column' );
