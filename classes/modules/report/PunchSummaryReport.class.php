...
//				if ( getTTProductEdition() >= PRODUCT_PROFESSIONAL_15 ) {
					...
					$custom_column_labels = $rcclf->getByCompanyIdAndTypeIdAndFormatIdAndScriptArray( $this->getUserObject()->getCompany(), array(10,20), NULL, 'PunchSummaryReport', 'custom_column' );
...
*/
	...
	function _getData( $format = NULL ) {
		...
		*/
// leancode REMOVE BELOW WHEN YOU ENABLE ABOVE
		$job_status_options = array();
