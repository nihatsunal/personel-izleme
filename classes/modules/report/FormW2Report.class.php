		...
		switch( $name ) {
            ...
            case 'report_custom_column':
				if ( getTTProductEdition() >= PRODUCT_PROFESSIONAL_15 ) {
					...
					$custom_column_labels = $rcclf->getByCompanyIdAndTypeIdAndFormatIdAndScriptArray( $this->getUserObject()->getCompany(), array(10,20), NULL, 'FormW2Report', 'custom_column' );
			...
			case 'dynamic_columns':
				$retval = array(
										...
										//'-2050-l12' => TTi18n::gettext('Box 13'),
										//'-2050-l12' => TTi18n::gettext('(12)'),
										//'-2050-l12' => TTi18n::gettext('(12)'),
										//'-2050-l12' => TTi18n::gettext('(12)'),
										//'-2050-l12' => TTi18n::gettext('(12)'),
							);
