...
class APIRecurringScheduleControl extends APIFactory {
	...
	function getCommonRecurringScheduleControlData( $data ) {
		return Misc::arrayIntersectByRow( $this->getRecurringScheduleControl( $data, TRUE ) );
	}
	...
	function copyRecurringScheduleControl( $data ) {
		...
		$src_rows = $this->getRecurringScheduleControl( array('filter_data' => array('id' => $data) ), TRUE );
