...
/*
 * $Revision: 2196 $
 * $Id: APIRecurringPayStubAmendment.class.php 2196 2008-10-14 16:08:54Z ipso $
...
class APIRecurringPayStubAmendment extends APIFactory {
	 ...
	 * @return array
	 */
	function getRecurringPayStubAmendmentDefaultData() {
	 ...
	 * @return array
	 */
	function getRecurringPayStubAmendment( $data = NULL, $disable_paging = FALSE ) {
	...
	function getCommonRecurringPayStubAmendmentData( $data ) {
		return Misc::arrayIntersectByRow( $this->getRecurringPayStubAmendment( $data, TRUE ) );
	}
	 ...
	 * @return array
	 */
	function validateRecurringPayStubAmendment( $data ) {
	 ...
	 * @return array
	 */
	function setRecurringPayStubAmendment( $data, $validate_only = FALSE ) {
	 ...
	 * @return array
	 */
	function deleteRecurringPayStubAmendment( $data ) {
		if ( is_numeric($data) ) {
			$data = array($data);
		}
	...
	function copyRecurringPayStubAmendment( $data ) {
		...
		$src_rows = $this->getRecurringPayStubAmendment( array('filter_data' => array('id' => $data) ), TRUE );
