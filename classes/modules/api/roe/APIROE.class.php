...
/*
 * $Revision: 2196 $
 * $Id: APIROE.class.php 2196 2008-10-14 16:08:54Z ipso $
...
class APIROE extends APIFactory {
	...
	function getCommonROEData( $data ) {
		return Misc::arrayIntersectByRow( $this->getROE( $data, TRUE ) );
	}
	...
	function copyROE( $data ) {
		...
		$src_rows = $this->getROE( array('filter_data' => array('id' => $data) ), TRUE );
