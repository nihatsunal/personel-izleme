...
/*
 * $Revision: 2196 $
 * $Id: APIUserTitle.class.php 2196 2008-10-14 16:08:54Z ipso $
...
class APIUserTitle extends APIFactory {
	...
	function getCommonUserTitleData( $data ) {
		return Misc::arrayIntersectByRow( $this->getUserTitle( $data, TRUE ) );
	}
	 ...
	 * @return array
	 */
	function setUserTitle( $data, $validate_only = FALSE ) {
	...
	function copyUserTitle( $data ) {
		...
		$src_rows = $this->getUserTitle( array('filter_data' => array('id' => $data) ), TRUE );
