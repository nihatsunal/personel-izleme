...
/*
 * $Revision: 2196 $
 * $Id: APIDepartment.class.php 2196 2008-10-14 16:08:54Z ipso $
...
class APIDepartment extends APIFactory {
	...
	function getCommonDepartmentData( $data ) {
		return Misc::arrayIntersectByRow( $this->getDepartment( $data, TRUE ) );
	}
	 ...
	 * @return array
	 */
	function setDepartment( $data, $validate_only = FALSE ) {
	...
	function copyDepartment( $data ) {
		...
		$src_rows = $this->getDepartment( array('filter_data' => array('id' => $data) ), TRUE );
