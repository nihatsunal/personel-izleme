...
class APIWageGroup extends APIFactory {
	...
	function getCommonWageGroupData( $data ) {
		return Misc::arrayIntersectByRow( $this->getWageGroup( $data, TRUE ) );
	}
	 ...
	 * @return array
	 */
	function setWageGroup( $data, $validate_only = FALSE ) {
	...
	function copyWageGroup( $data ) {
		...
		$src_rows = $this->getWageGroup( array('filter_data' => array('id' => $data) ), TRUE );
