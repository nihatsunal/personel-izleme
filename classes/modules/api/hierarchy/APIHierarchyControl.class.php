...
/*
 * $Revision: 2196 $
 * $Id: APIHierarchyControl.class.php 2196 2008-10-14 16:08:54Z ipso $
...
class APIHierarchyControl extends APIFactory {
	...
	function getCommonHierarchyControlData( $data ) {
		return Misc::arrayIntersectByRow( $this->getHierarchyControl( $data, TRUE ) );
	}
	 ...
	 * @return array
	 */
	function setHierarchyControl( $data, $validate_only = FALSE ) {
	...
	function copyHierarchyControl( $data ) {
		...
		$src_rows = $this->getHierarchyControl( array('filter_data' => array('id' => $data) ), TRUE );
