...
class APISchedulePolicy extends APIFactory {
	 ...
	 * @return array
	 */
	function getCommonSchedulePolicyData( $data ) {
		return Misc::arrayIntersectByRow( $this->getSchedulePolicy( $data, TRUE ) );
	}
	 ...
	 * @return array
	 */
	function validateSchedulePolicy( $data ) {
	 ...
	 * @return array
	 */
	function setSchedulePolicy( $data, $validate_only = FALSE ) {
	 ...
	 * @return array
	 */
	function deleteSchedulePolicy( $data ) {
		if ( is_numeric($data) ) {
			$data = array($data);
		}
	 ...
	 * @return array
	 */
	function copySchedulePolicy( $data ) {
		if ( is_numeric($data) ) {
			$data = array($data);
		}
		...
		$src_rows = $this->getSchedulePolicy( array('filter_data' => array('id' => $data) ), TRUE );
